...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Settings (Other settings available in GeantWrapper.sh)
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
numproc=16          # Number of processors to run Dakota
...
cp $homedir/GeantWrapper.sh $homedir/GeantEval$1.sh
sed -i -e  "s?StartSource=1?StartSource=$StartSource?g" "$homedir/GeantEval$1.sh"
sed -i -e  "s?MaskMinThick=0.4053?MaskMinThick=$min_thick?g" "$homedir/GeantEval$1.sh"
sed -i -e  "s?numproc=2?numproc=$numproc?g" "$homedir/GeantEval$1.sh"
...
sed -i -e  "s?numproc=2?numproc=$numproc?g" "$homedir/GeantEval$1.sh"
sed -i -e  "s?threads=2?threads=$geantthreads?g" "$homedir/GeantEval$1.sh"
